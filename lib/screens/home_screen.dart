...
class _HomeScreenState extends State<HomeScreen>
  ...
  Future<void> _loadRecentActivities() async {
    ...
    final result = await _activityService.getRecentActivities(
    ...
    if (mounted) {
      setState(() {
        ...
        if (result.success) {
          _recentActivities = result.activities;
        }
      });
    }
  }
            ...
            children: [
              ...
              if (_isLoadingActivities)
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 4),
                      const Text(
                        'Buat pesanan atau ambil pengiriman untuk memulai',
                        style: TextStyle(
                          color: AppColors.textTertiary,
                          fontSize: 12,
                        ),
                ...
                ..._recentActivities.map(
                  (activity) => _buildActivityItemFromData(activity),
                ),
            ],
          ),
        ),
  ...
  /// Build activity item from Activity data
  Widget _buildActivityItemFromData(Activity activity) {
  ...
  IconData _getActivityIcon(String type) {
    switch (type) {
      ...
      case ActivityType.orderClaimed:
      ...
      case ActivityType.pointsSpent:
        return Icons.shopping_bag_rounded;
      case ActivityType.pointsTransferred:
        return Icons.send_rounded;
      case ActivityType.pointsReceived:
